...
<head>
    ...
    <title>{{ __('নিবন্ধন') }} — {{ __('ব্লাড ব্যাংক') }}</title>
...
@media (max-width: 575.98px) {
    ...
    /* skeleton gutters */
    #register-skeleton > div { padding-left: 16px !important; padding-right: 16px !important; }

    /* the register form is the longest one — tighten it a little further so
       four fields + button still fit on a small phone without scrolling */
    div[style*="min-height:100vh"] { padding: 6px 14px !important; }
    div[style*="letter-spacing:2px"] { display: none !important; }
    div[style*="padding:28px 32px 20px"] { padding: 9px 18px 6px !important; }
    div[style*="padding:26px 32px"] { padding: 9px 18px !important; }
    div[style*="margin-bottom:16px"] { margin-bottom: 7px !important; }
    div[style*="margin-bottom:18px"] { margin-bottom: 7px !important; }
    label[style*="margin-bottom:7px"] { margin-bottom: 4px !important; }
    input[style*="padding:12px"] { padding-top: 8px !important; padding-bottom: 8px !important; }
    button[style*="padding:13px"] { padding: 9px !important; }
    div[style*="margin-top:18px"] { margin-top: 6px !important; }
}
</style>
